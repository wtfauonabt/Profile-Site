					...
					<header class="entry-header">
						<div class="entry-meta">
							<?php
								...
								printf( __( 'Published ', 'experon') . '<span><time datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="' . esc_attr__( 'Link to full-size image', 'experon' ) . '">%4$s &times; %5$s</a> in <a href="%6$s" title="' . esc_attr__( 'Return to ', 'experon' ) . '%7$s" rel="gallery">%8$s</a>',
